...
#' \emph{Privacy in Statistical Databases}, \strong{6344} of Lecture Notes in Computer Science, 174--186. Springer Verlag, Heidelberg. doi: 10.1007/978-3-642-15838-4\_16
#' 
#' @keywords package
#' @examples
#'
